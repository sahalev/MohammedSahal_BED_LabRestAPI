...
<div class="container p-3 my-3 bg-primary text-white">
 ...
 <a href="students/list" class="btn btn-outline-warning btn-lg">Participants GL Fest </a>
 <a href="students/showForm" class="btn btn-outline-warning btn-lg">Add Participant</a>
 <a href="/logout" class="btn btn-outline-warning btn-lg">Logout</a>
